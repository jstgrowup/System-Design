    ...
    <nav className="bg-primary-900 text-white shadow-lg sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <span className="bg-white text-primary-900 rounded px-1.5 py-0.5 text-sm font-black">
              IR
            </span>
            <span>IRCTC</span>
          </Link>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <Link
              to="/search"
              className="px-3 py-2 rounded-lg text-sm font-medium hover:bg-primary-800 transition-colors"
            >
              Search
            </Link>
            ...
            {isAuthenticated ? (
              ...
              <Link
                to="/login"
                className="px-3 py-1.5 rounded-lg text-sm font-medium bg-accent-700 hover:bg-accent-600 transition-colors"
              >
                Login
              </Link>
            )}
