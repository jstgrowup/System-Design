...
/**
 * Union type of every valid Kafka topic string, derived from KAFKA_TOPICS.
 * Use this to type `topic` parameters across producers/consumers so only
 * known topic names are accepted at compile time.
 */
