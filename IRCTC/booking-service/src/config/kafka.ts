...
/**
 * Kafka producer instance, for BOOKING_CONFIRMED / BOOKING_CANCELLED / BOOKING_FAILED.
...
/**
 * Kafka consumer instance for PAYMENT_SUCCESS / PAYMENT_FAILED / SCHEDULE_CANCELLED.
